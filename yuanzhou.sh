...
echo -e "${kjlan}-输入${huang}yz${kjlan}可快速启动此脚本-${bai}"
echo "------------------------"
echo "1. 系统信息查询"
echo "2. 系统更新"
echo "3. 系统清理"
...
case $choice in
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      mkdir $yuming
      cd $yuming
      wget -O latest.zip https://hub.gitmirror.com/https://github.com/kejilion/Website_source_code/raw/main/Discuz_X3.5_SC_UTF8_20240520.zip
      unzip latest.zip
      rm latest.zip
    ...
    while true; do
      ...
      case $sub_choice in
          ...
          37)
            ...
            docker_url="官网介绍: https://hub.gitmirror.com/https://github.com/jason5ng32/MyIP/blob/main/README_ZH.md"
            docker_use=""
            docker_passwd=""
            docker_app
              ;;
