...
install_add_docker() {
    if [ -f "/etc/alpine-release" ]; then
        ...
        if [ "$country" = "CN" ]; then           
            cd ~
            curl -sS -O https://raw.gitmirror.com/yuanzhou/docker/main/install && chmod +x install
            sh install --mirror Aliyun
            rm -f install          
            cat > /etc/docker/daemon.json << EOF
{
    "registry-mirrors": ["https://docker.yuanzhou.pro"]
}
EOF
        else
...
install_certbot() {
    ...
    # 下载并使脚本可执行
    curl -O https://raw.githubusercontent.com/yuanzhou/sh/main/auto_cert_renewal.sh
...
reverse_proxy() {
      ip_address
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/reverse-proxy.conf
...
cluster_python3() {
    cd ~/cluster/
    curl -sS -O https://raw.githubusercontent.com/yuanzhou/python-for-vps/main/cluster/$py_task
...
f2b_install_sshd() {
    ...
    if grep -q 'Alpine' /etc/issue; then
        ...
        curl -sS -O https://raw.githubusercontent.com/yuanzhou/config/main/fail2ban/alpine-sshd.conf
        curl -sS -O https://raw.githubusercontent.com/yuanzhou/config/main/fail2ban/alpine-sshd-ddos.conf
        cd /path/to/fail2ban/config/fail2ban/jail.d/
        curl -sS -O https://raw.githubusercontent.com/yuanzhou/config/main/fail2ban/alpine-ssh.conf
    elif grep -qi 'CentOS' /etc/redhat-release; then
        cd /path/to/fail2ban/config/fail2ban/jail.d/
        curl -sS -O https://raw.githubusercontent.com/yuanzhou/config/main/fail2ban/centos-ssh.conf
    else
        install rsyslog
        systemctl start rsyslog
        systemctl enable rsyslog
        cd /path/to/fail2ban/config/fail2ban/jail.d/
        curl -sS -O https://raw.githubusercontent.com/yuanzhou/config/main/fail2ban/linux-ssh.conf
    fi
}
...
root_use() {
clear
[ "$EUID" -ne 0 ] && echo -e "${huang}请注意，该功能需要root用户才能运行！${bai}" && break_end && yuanzhou
}
...
echo -e "${qingse}_  _ ____  _ _ _    _ ____ _  _ "
echo "|_/  |___  | | |    | |  | |\ | "
echo "| \_ |___ _| | |___ | |__| | \| "
echo "                                "
echo -e "${qingse}科技lion一键脚本工具 v$sh_v （支持Ubuntu/Debian/CentOS/Alpine系统）${bai}"
...
case $choice in
  ...
  while true; do
    ...
    case $sub_choice in
      ...
      wget -O /home/web/nginx.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/nginx10.conf
      wget -O /home/web/conf.d/default.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/default10.conf
      default_server_ssl

      # 下载 docker-compose.yml 文件并进行替换
      wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/yuanzhou/docker/main/LNMP-docker-compose-10.yml

      dbrootpasswd=$(openssl rand -base64 16) && dbuse=$(openssl rand -hex 4) && dbusepasswd=$(openssl rand -base64 8)

      # 在 docker-compose.yml 文件中进行替换
      sed -i "s#webroot#$dbrootpasswd#g" /home/web/docker-compose.yml
      sed -i "s#yuanzhouYYDS#$dbusepasswd#g" /home/web/docker-compose.yml
      sed -i "s#yuanzhou#$dbuse#g" /home/web/docker-compose.yml
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/wordpress.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/discuz.com.conf
      ...
      mkdir $yuming
      cd $yuming
      wget -O latest.zip https://github.com/yuanzhou/Website_source_code/raw/main/Discuz_X3.5_SC_UTF8_20240520.zip
      unzip latest.zip
      rm latest.zip
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/kdy.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/maccms.com.conf
      ...
      cd /home/web/html/$yuming/template/ && wget https://github.com/yuanzhou/Website_source_code/raw/main/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/$yuming/template/DYXS2.zip
      cp /home/web/html/$yuming/template/DYXS2/asset/admin/Dyxs2.php /home/web/html/$yuming/application/admin/controller
      cp /home/web/html/$yuming/template/DYXS2/asset/admin/dycms.html /home/web/html/$yuming/application/admin/view/system
      mv /home/web/html/$yuming/admin.php /home/web/html/$yuming/vip.php && wget -O /home/web/html/$yuming/application/extra/maccms.php https://raw.githubusercontent.com/yuanzhou/Website_source_code/main/maccms.php
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/dujiaoka.com.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/flarum.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/typecho.com.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/index_php.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/rewrite.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/reverse-proxy-domain.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
      ...
      wget -O /home/web/conf.d/$yuming.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/html.conf
      sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    33)
      ...
      cd ~
      wget -O ${useip}_beifen.sh https://raw.githubusercontent.com/yuanzhou/sh/main/beifen.sh > /dev/null 2>&1
    ...
    35)
        ...
        if docker inspect fail2ban &>/dev/null ; then
          while true; do
              ...
              case $sub_choice in
                  ...
                  21)
                      ...
                      wget -O /home/web/conf.d/default.conf https://raw.githubusercontent.com/yuanzhou/nginx/main/default11.conf
                      docker restart nginx

                      cd /path/to/fail2ban/config/fail2ban/jail.d/
                      curl -sS -O https://raw.githubusercontent.com/yuanzhou/config/main/fail2ban/nginx-docker-cc.conf

                      cd /path/to/fail2ban/config/fail2ban/action.d
                      curl -sS -O https://raw.githubusercontent.com/yuanzhou/config/main/fail2ban/cloudflare-docker.conf

                      sed -i "s/yuanzhou@outlook.com/$cfuser/g" /path/to/fail2ban/config/fail2ban/action.d/cloudflare-docker.conf
          ...
          cd /path/to/fail2ban/config/fail2ban/filter.d
          curl -sS -O https://raw.githubusercontent.com/yuanzhou/sh/main/fail2ban-nginx-cc.conf
          cd /path/to/fail2ban/config/fail2ban/jail.d/
          curl -sS -O https://raw.githubusercontent.com/yuanzhou/config/main/fail2ban/nginx-docker-cc.conf
    ...
    36)
          while true; do
              ...
              case $sub_choice in
                  ...
                  # php调优
                  wget -O /home/optimized_php.ini https://raw.githubusercontent.com/yuanzhou/sh/main/optimized_php.ini
                  docker cp /home/optimized_php.ini php:/usr/local/etc/php/conf.d/optimized_php.ini
                  docker cp /home/optimized_php.ini php74:/usr/local/etc/php/conf.d/optimized_php.ini
                  rm -rf /home/optimized_php.ini

                  # php调优
                  wget -O /home/www.conf https://raw.githubusercontent.com/yuanzhou/sh/main/www-1.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://raw.githubusercontent.com/yuanzhou/sh/main/custom_mysql_config-1.cnf
                  ...
                  # php调优
                  wget -O /home/www.conf https://raw.githubusercontent.com/yuanzhou/sh/main/www.conf
                  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
                  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
                  rm -rf /home/www.conf

                  # mysql调优
                  wget -O /home/custom_mysql_config.cnf https://raw.githubusercontent.com/yuanzhou/sh/main/custom_mysql_config.cnf
                  docker cp /home/custom_mysql_config.cnf mysql:/etc/mysql/conf.d/
                  rm -rf /home/custom_mysql_config.cnf
            ...
            if docker inspect cloudreve &>/dev/null; then
                    ...
                    case $sub_choice in
                        1)
                            ...
                            curl -o /home/docker/cloud/docker-compose.yml https://raw.githubusercontent.com/yuanzhou/docker/main/cloudreve-docker-compose.yml
    ...
    while true; do
      ...
      case $sub_choice in
          1)
              ...
              echo "alias $kuaijiejian='~/yuanzhou.sh'" >> ~/.bashrc
              source ~/.bashrc
              echo "快捷键已设置"
              ;;
            ...
            while true; do
                  ...
                  case $sub_choice in
                      1)
                        ...
                        wget -qO - https://raw.githubusercontent.com/yuanzhou/sh/main/archive.key | gpg --dearmor -o /usr/share/keyrings/xanmod-archive-keyring.gpg --yes

                        # 步骤3：添加存储库
                        echo 'deb [signed-by=/usr/share/keyrings/xanmod-archive-keyring.gpg] http://deb.xanmod.org releases main' | tee /etc/apt/sources.list.d/xanmod-release.list

                        # version=$(wget -q https://dl.xanmod.org/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
                        version=$(wget -q https://raw.githubusercontent.com/yuanzhou/sh/main/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
...
EOF
          ...
          21)
              ...
              while true; do
                  ...
                  case $host_dns in
                      1)
                          read -p "请输入新的解析记录 格式: 110.25.5.33 yuanzhou.pro : " addhost
          ...
          23)
            ...
            case "$Limiting" in
              1)
                ...
                cd ~
                curl -Ss -O https://raw.githubusercontent.com/yuanzhou/sh/main/Limiting_Shut_down.sh
...
EOF
  ...
  p)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/yuanzhou/sh/main/palworld.sh && chmod +x palworld.sh && ./palworld.sh
    exit
    ;;
  ...
  00)
    ...
    echo "更新日志"
    echo "------------------------"
    echo "全部日志: https://raw.githubusercontent.com/yuanzhou/sh/main/yuanzhou_sh_log.txt"
    echo "------------------------"
    curl -s https://raw.githubusercontent.com/yuanzhou/sh/main/yuanzhou_sh_log.txt | tail -n 35

    sh_v_new=$(curl -s https://raw.githubusercontent.com/yuanzhou/sh/main/yuanzhou.sh | grep -o 'sh_v="[0-9.]*"' | cut -d '"' -f 2)
    ...
    if [ "$sh_v" = "$sh_v_new" ]; then
        ...
        case "$choice" in
            [Yy])
                clear
                curl -sS -O https://raw.githubusercontent.com/yuanzhou/sh/main/yuanzhou.sh && chmod +x yuanzhou.sh
